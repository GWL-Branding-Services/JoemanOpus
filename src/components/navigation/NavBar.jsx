...
function NavBar() {
  ...
  return (
    <header className=" shadow-md bg-gwltheme  w-screen -top-1 z-[150]  fixed mx-auto">
      <nav
      ...
      >
        ...
        <div
          ...
          className="hidden lg:flex lg:gap-x"
        >
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto overflow-x-hidden bg-gwltheme px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
